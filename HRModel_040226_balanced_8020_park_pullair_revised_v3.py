...
def score_matchup(
    ...
    pitcher_profile, pitcher_metrics = build_pitcher_profile(pitcher_id, batter_hand, refresh_cache=refresh_cache)
...
def run_model(
    ...
    if show_head:
        cols = [
            "batter", "team", "pitcher", "opponent", "park_team", "park_resolved",
            "park_factor_hr", "batter_barrel_pct", "batter_pull_air_pct", "hr_probability_pa", sort_col
        ]
